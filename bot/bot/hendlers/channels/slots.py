...
from db import async_mian_session, GroupsTable, update_user_stmt
            ...
            if group:
                ...
                if com in slots_dict.keys():
                    ...
                    for rls in res.all():
                        ...
                        await async_mian_session.execute(do_update_stmt)
                    ...
                    await async_mian_session.execute(user_stmt)
